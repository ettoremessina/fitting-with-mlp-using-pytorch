...
python ../pmc2t_fit_2.py --trainds datasets/example2_2_train.csv --modelout models/example2_2.pth \
...
python ../pmc2t_predict_2.py --model models/example2_2.pth --testds datasets/example2_2_test.csv --predicted predictions/example2_2_pred.csv
