...
python ../pmc2t_fit_1.py --trainds datasets/example2_1_train.csv --modelout models/example2_1 \
...
python ../pmc2t_predict_1.py --model models/example2_1 --testds datasets/example2_1_test.csv --predicted predictions/example2_1_pred.csv
