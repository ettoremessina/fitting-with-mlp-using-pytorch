...
python ../pmc2t_fit_1.py --trainds datasets/example1_1_train.csv --modelout models/example1_1.pth \
...
python ../pmc2t_predict_1.py --model models/example1_1.pth --testds datasets/example1_1_test.csv --predicted predictions/example1_1_pred.csv
